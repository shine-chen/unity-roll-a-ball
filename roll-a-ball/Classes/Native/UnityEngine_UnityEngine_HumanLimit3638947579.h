...
struct HumanLimit_t3638947579_marshaled
{
	Vector3_t3525329789_marshaled ___m_Min_0;
	Vector3_t3525329789_marshaled ___m_Max_1;
	Vector3_t3525329789_marshaled ___m_Center_2;
	float ___m_AxisLength_3;
	int32_t ___m_UseDefaultValues_4;
};
